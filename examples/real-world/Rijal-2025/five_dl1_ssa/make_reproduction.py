#!/usr/bin/env python
"""Reproduce the 5DL1 mean/Fano curve with exact BNGsim SSA trajectories.
...
CONF = HERE / "five_dl1_ssa.conf"
EXP = HERE / "five_dl1.exp"
SOURCE = HERE / "jones_fig3a_source.tsv"
OUT = HERE / "five_dl1_ssa_reproduction.png"
SUFFIX = "five_dl1"
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="five-dl1-bngsim-") as tmp:
        work = Path(tmp)
    ...
    axes[0].set_title("5DL1: variability curve")
