...
numkeys_float = ['extra_weight', 'swap_rate', 'min_objective', 'cognitive', 'social', 'particle_weight',
                 ...
                 'beta_max', 'bootstrap_max_obj', 'simplex_stop_tol', 'v_stop']
...
strkeylist = ['bng_command', 'job_name', 'output_dir', 'fit_type', 'objfunc', 'initialization',
              'cluster_type', 'scheduler_node', 'de_strategy']
...
def parse(s):
    ...
    mdmgram = mdmkey - equals - model_file - pp.Optional(colon - pp.delimitedList(exp_file)) - comment
